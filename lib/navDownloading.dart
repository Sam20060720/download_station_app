              ...
              children: [
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    color: ThemeData.estimateBrightnessForColor(Theme.of(context).canvasColor) == Brightness.dark ? const Color.fromARGB(26, 142, 142, 142) : const Color.fromARGB(0, 189, 189, 189),
                                          ...
                                          Row(
                                            ...
                                            children: [
                                              Expanded(
                                                  ...
                                                  child: Container(
                                                    child:
                                                        Row(children: [getFileStatusIcon(item.status), const SizedBox(width: 5), Expanded(child: Text(item.title, overflow: TextOverflow.ellipsis))]),
                                                  )),
                                              Expanded(
                                                  flex: 1,
                                                  child: Container(
